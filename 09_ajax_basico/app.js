...
function main(){
    ...
    function pedirDatos(){
        ...
        // Primera forma de poner el objeto en escucha
        ajax.addEventListener('readystatechange', mostrarDatos)

        // Segunda forma de poner el objeto en escucha
        //ajax.onreadystatechange = mostrarDatos

        ajax.open('GET', 'datos.json')
        // El método send, pasarle otros parámetros, se tiene que mandar en POST
        ajax.send(null)
